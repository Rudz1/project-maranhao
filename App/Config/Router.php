...
class Router {
    ...
    public static function configRouters(\Framework\Router\Routing $router) {
        ...
        //router - admin - culture - content
        $router->get('/admin/footer-pages-table', \App\Models\FooterPages\Controllers\Admin\AdminController::class, 'list');
        $router->get('/admin/footer-pages-add', \App\Models\FooterPages\Controllers\Admin\AdminController::class, 'addForm');
        $router->post('/admin/footer-pages-add-save', \App\Models\FooterPages\Controllers\Admin\AdminController::class, 'add');
        $router->get('/admin/footer-pages-edit', \App\Models\FooterPages\Controllers\Admin\AdminController::class, 'editForm');
        $router->post('/admin/footer-pages-edit-save', \App\Models\FooterPages\Controllers\Admin\AdminController::class, 'edit');
        $router->get('/admin/footer-pages-delete', \App\Models\FooterPages\Controllers\Admin\AdminController::class, 'delete');
    }
